...
$(document).on('click', '#dispListTrk_NewLoadButton', function (e) {
    ...
    $("#tabDispLists_trks").load("services/fetch_pages_new.php",{"sqlFilterString":fetch_pages_filterString,"page":page}); //get content from PHP page
...
$(document).on('click', '.pagination a', function (e){  // "#tabDispLists_trks"
    ...
    $("#tabDispLists_trks").load("services/fetch_pages_new.php",{"object":"trk","sqlFilterString":fetch_pages_filterString,"page":page}, function(){ //get content from PHP page
...
$(document).on('click', '#uiTrack_fld_save', function ( e ) {
    ...
    if ( valid ) {                                                      // all validation checks were successful
        phpLocation = "services/putObject_new.php";                                 // Variable to store location of php file
        ...
        .done(function ( respObj ) {
            ...
            if ( respObj.status == 'OK' ) {
                ...
                var jsonObject = {};
                phpLocation = "services/gen_kml_new.php";                                   // Variable to store location of php file
