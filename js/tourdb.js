...
trackFileNameURL = document.URL + "tmp/kml_disp/" + trackFileName;
...
$(document).on('click', '.applyFilterButton', function (e) {
    ...
    */
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {  
            responseObject = JSON.parse(xhr.responseText);                                              // transfer JSON into response object array
            trackKml = responseObject.trackKml; 
            //loginstatus = responseObject.loginstatus;
            ...
            //drawMapOld('displayMap-ResMap', trackFileNameURL, "", 0, 0, 0, 1, 0); // Draw map to panel
            //drawMapNew('displayMap-ResMap', trackFileNameURL);             // Draw track map to panel
            drawTrackLayer($map, trackKml);
            //drawMapNew('displayMap-ResMap', trackFileNameURL);
            //addMapFeatures($map);                                               // add specific map features
